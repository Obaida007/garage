...
export const api = {
  ...
  createPriorityTicket: () => invoke<CreateTicketResult>("create_priority_ticket"),
  ...
  renameBay: (bayId: number, name: string) => invoke<Bay>("rename_bay", { bayId, name }),
  addBay: (name: string) => invoke<Bay>("add_bay", { name }),
  setBayActive: (bayId: number, active: boolean) => invoke<Bay>("set_bay_active", { bayId, active }),
  uploadLogo: (sourcePath: string) => invoke<string>("upload_logo", { sourcePath }),
  ...
  resetNumbering: () => invoke<void>("reset_numbering"),
